        ...
        <div>
                        ...
                        <div class="collapse navbar-collapse tm-nav" id="navbar-nav">
                            <ul class="navbar-nav text-uppercase">
                                <li class="nav-item active">
                                    <router-link class="nav-link tm-nav-link" to="/">Home <span class='sr-only'>(current)</span></router-link>
                                </li>
                                <li class="nav-item">
            ...
            <div class="tm-row">
                ...
                <main class="tm-col-right">
                    <section class="tm-content" v-for="data in homeData">
                        <h2 class="mb-5 tm-content-title">{{ data.title }}</h2>
                        <p class="mb-5">{{ data.text_1 }}</p>
                        <hr class="mb-5">
                        <p class="mb-5">{{ data.text_2 }}</p>
